Public Class frmTextFiles
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        'opens an output file as append.  
        'Append means to add to an existing file if the existing file is there.
        'If the file is not there, it will be created.

        'You can also use Create means to add the file if it is not there. 
        'If it is there, it will delete the file and start all over. 

        EmpFile = System.IO.File.AppendText(strFileName)


        'EmpFile = System.IO.File.CreateText(strFileName)
        ...
        'I am going to write a complete record with the following fields
        'delimited with a comma. 
        'NOTE the "Write" method will write the field and position the 
        'cursor right after the written field. 
        '"WriteLine" will write the field and position the cursor
        'on the next line. 
